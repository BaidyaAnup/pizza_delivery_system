class PizzasController < ApplicationController
  ...
  # end
  def delete_multiple
    Pizza.destroy(params[:pizzas])
    respond_to do |format|
      format.html { redirect_to pizzas_url, notice: 'Pizzas were successfully destroyed.' }
      format.json { head :no_content }
    end
  end
  ...
  private
    ...
    def pizza_params
      params.require(:pizza).permit(:name, :size, :variety, :price)
    end
end
